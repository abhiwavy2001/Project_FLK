<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AddProduct.aspx.cs" Inherits="Project_FLK.AddProduct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="w-100">
        ...
        <tr>
            <td class="auto-style2">
                <asp:Label ID="Label5" runat="server" Text="Product Status"></asp:Label>
            </td>
            <td>
